...
public class FXMLDocumentController implements Initializable {
 ...
 //When you push number buttons FIRST METHOD
 public void Number (ActionEvent ae){
     String no = ((Button)ae.getSource()).getText();
     txt_result.setText(txt_result.getText()+no);
 }
 
 //When you push operator buttons SECOND METHOD
 ...
 // This is the calculations THIRD METHOD
  public void calculate (long n1, long n2, String op) {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // First draft. Is functioning. Would like to add a clear button 
    }    
